...
export default function PackagesPage() {
  ...
  // Ambil daftar paket sesuai filter
  ...
  // Sinkronkan state lokal & ambil paket saat filter berubah
  useEffect(() => {
      ...
      <section className="py-24 bg-gradient-to-b from-white to-blue-50/30 dark:from-background dark:to-blue-950/30">
        <div className="container mx-auto px-4">
          <div className="flex justify-between">
            <h1 className="text-3xl font-bold mb-6 bg-gradient-to-r from-gray-900 to-blue-800 bg-clip-text text-transparent dark:from-white dark:to-blue-200">
